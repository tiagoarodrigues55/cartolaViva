...
module.exports = {
    ...
    async store(req, res) {
        const { name, img, media, preço, ultimapontuação, valorização, jogos } = req.body

        const jogadores = await Jogadores.create({ name, img, media, preço, ultimapontuação, valorização, jogos })
